...
<div class="row"> 
    <ol class="breadcrumb">
	  <li><i class="fa fa-home"></i>LAPORAN EFAKTUR</li> 
	</ol> 
	<section class="panel">
	   ...
	   <div class="form-group col-xs-12 col-sm-2 ">
		...
		<input name="sdtgl" id="dp2" type="text" value="<?php echo $sdtgl?>"  size="16" class="form-control"  > 
			  ...
			  <div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6"> 
				 <input type="hidden" name="par" id="par" value="16">
	  ...
	  <div align="center">
		 ...
		 ?>
		<br>
		<?php echo " EFaktur Tanggal ". $tgl. "&nbsp;&nbsp;&nbsp; Sampai Dengan " .$sdtgl; ?>
	  </div>
	   <div class="box-body">
		  ...
		  <?php
			if($_GET['']!==""){
	           $kodcustomer=($_GET['kodcustomer']); 
			    try {  	
			        $strsql = "select * from tinvoice where tglefaktur>='$tgl' and tglefaktur<='$sdtgl' and isbayarefaktur like '$statusbayar' order by tglefaktur";	
					...
					while($rs = $sql->fetch()) { 
					   ...
					   echo "   <tr>
						  ...
						  <td><font size=-1>".$rs['noefaktur']."</font></td>
						  <td><font size=-1>".$rs['tglefaktur']."</font></td>
						  <td><font size=-1>".number_format($rs['bsuefaktur'],0,',','.')."</font></td> 
						  <td><font size=-1>".$status."</font></td>
						  <td><font size=-1>".$rs['tglbayarefaktur']."</font></td> 
						  "?>
							</form> 

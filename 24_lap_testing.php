...
<body>
	...
	<div class="row">
		<ol class="breadcrumb">
			<li><i class="fa fa-home"></i>LAPORAN TESTING YANG MASIH OPEN</li>
		</ol>
		<section class="panel">
						...
						<div>
							...
							<tbody>
								...
								if ($_GET[''] !== "") {
									...
									try {
										$strsql = "SELECT a.idlog,a.userorder, a.iduser, b.nmcustomer,a.fasorder, a.tglorder,a.tgltarget, a.desorder, a.deslayan, a.tglselesai from tlog a inner join rcustomer b  on a.kodcustomer =b.kodcustomer where a.isselesai=1 and a.istesting=0 and a.stsdel=0 order by a.tglorder, a.idlog";

...
<div class="row"> 
    <ol class="breadcrumb">
	  <li><i class="fa fa-home"></i>LAPORAN PPH</li> 
	</ol> 
	<section class="panel">
	   ...
	   <div class="form-group col-xs-12 col-sm-2 ">
		...
		<input name="sdtgl" id="dp2" type="text" value="<?php echo $sdtgl?>"  size="16" class="form-control"  > 
			  ...
			  <div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6"> 
				 <input type="hidden" name="par" id="par" value="17">
	  ...
	  <div align="center">
		 ...
		 ?>
		<br>
		<?php echo " PPh Tanggal ". $tgl. "&nbsp;&nbsp;&nbsp; Sampai Dengan " .$sdtgl; ?>
	  </div>
	   <div class="box-body">
			    ...
			    try {  	
					...
					while($rs = $sql->fetch()) { 
					   ...
					   echo "   <tr>
						  ...
						  <td><font size=-1>".$rs['nopph']."</font></td>
						  <td><font size=-1>".$rs['tglpph']."</font></td>
						  <td><font size=-1>".number_format($rs['bsupph'],0,',','.')."</font></td> 
						  <td><font size=-1>".$status."</font></td>
						  <td><font size=-1>".$rs['tglbayarpph']."</font></td> 
						  "?>
							</form> 
